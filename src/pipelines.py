...
def get_camera_resulotion(
    video_width: int = 640, video_height: int = 640
) -> tuple[int, int]:
...
def SOURCE_PIPELINE(
    ...
    name: str = "source",
    no_webcam_compression: bool = False,
) -> str:
    """
...
def FILE_SINK_PIPELINE(
    output_file: str = "output.mkv", name: str = "file_sink", bitrate: int = 5000
) -> str:
    """
